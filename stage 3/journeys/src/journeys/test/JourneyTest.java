...
public class JourneyTest {
  ...
  public void saveOrUpdate() {
	  ...
	  journey.setNumber_of_places(100L);
	  journeydao.saveOrUpdate(journey);

	  journey = journeydao.findById(1L);
	  Assert.assertEquals(journey.getNumber_of_places().longValue(), 100);

	  journey.setNumber_of_places(10L);
	  journeydao.saveOrUpdate(journey);
  }
  ...
  public void delete() {
      ...
      journey.setDirection(new DirectionDAO().findById(1L));
	  journey.setCompany(new CompanyDAO().findById(1L));
	  journey.setNumber_of_places(10L);
	  ...
	  journey.setStart_date(date);
      journey.setStart_time(time);
	  journeydao.saveOrUpdate(journey);
