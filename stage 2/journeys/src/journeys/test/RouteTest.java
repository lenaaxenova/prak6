...
public class RouteTest {
  ...
  public void saveOrUpdate() {
	  ...
	  route.set_time_of_stop(5);
	  routedao.saveOrUpdate(route);

	  route = routedao.findById(1L);
	  Assert.assertEquals(route.get_time_of_stop(), 5);

	  route.set_time_of_stop(0);
	  routedao.saveOrUpdate(route);
  }
  ...
  public void delete() {
	  ...
	  route.set_journey(new JourneyDAO().findById(1L));
	  route.set_station(new StationDAO().findById(1L));
	  route.set_time_offset(0);
	  route.set_time_of_stop(0);
	  route.set_cost_offset(0);
	  routedao.saveOrUpdate(route);
